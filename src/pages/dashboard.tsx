...
import { useRoqPlatformUserProfiles, useProductCount, useOrderItemCount, useOrderCount } from 'lib/roq';

import { ProductListPage as ShowCaseList } from 'pages/products';

function DashboardPage() {
  const { session } = useSession();

  const productStat = useProductCount();
