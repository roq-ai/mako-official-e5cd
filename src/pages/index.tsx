...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`mako official`}</title>

        <meta
          name="description"
          content="Welcome to Mako Official - Your ultimate platform for seamless ecommerce experiences. Unleash the power of online shopping with us."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2V8ZW58MHx8fHwxNjk5Njc4NTM0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@rupixen?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`rupixen.com`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Mako Official - Your ultimate platform for seamless ecommerce experiences. Unleash the power of online shopping with us.`}
            </Text>
            <Box
