...
import { useInventoryFindFirst, useRoqClient } from 'lib/roq';
...
function InventoryViewPage() {
  ...
  const queryParams = useMemo<{ include: { product: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useInventoryFindFirst(queryParams, {}, { disabled: !id });
