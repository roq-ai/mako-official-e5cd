...
import { useRoqClient, useInventoryFindManyWithCount } from 'lib/roq';
...
export function InventoryListPage(props: InventoryListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useInventoryFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.inventory.delete({ where: { id } });
      await mutate();
    } catch (error) {
